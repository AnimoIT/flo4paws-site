...
W-series register entry (ruling A, W6b, 5 Sep 2026: W register lives in `flo4paws-site/docs/`, not `animoit-infra`). Numbering continues from WF-87 (W3).

---

### WF-88 | W4 | MEASURED | a standing rule was in the brief and still not applied
...
### WF-89 | W4 | MEASURED | a phrase grep nearly filed a false absence on the production estate
...
### WF-91 | W4 | MEASURED | `gh pr merge --delete-branch` leaves the local branch when you checkout main first
