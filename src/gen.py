...
NAV_ITEMS = [('/', 'Home'), ('/about/', 'About Flo'), ('/how-it-works/', 'My approach'), ('/guides/', 'Guides'), ('/walks/', 'Walks'), ('/flos-friends/', "Flo's Friends")]
